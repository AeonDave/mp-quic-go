...
//
//	mockgen -typed -package quic -self_package github.com/AeonDave/mp-quic-go -self_package github.com/AeonDave/mp-quic-go -destination mock_packetconn_test.go net PacketConn
//
